...
export default async function AiSettingsPage() {
  ...
  return (
    <>
      <PageHeader
        title="AI settings"
        description="Provider key status and how the execution engine resolves a model at runtime."
      />
      <div className="stack">
        <div className="list">
          {providers.map((p) => (
        ...
        <section className="card">
          ...
          <div className="prose" style={{ fontSize: 14 }}>
            <ol>
              ...
              <li>
                Add any model ID to the catalog under Settings → AI models, then point a template&apos;s default
                model at it.
              </li>
            </ol>
          </div>
