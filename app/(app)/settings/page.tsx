...
export default async function SettingsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Settings"
        description="Appearance, account, and operational guidelines."
      />
      <div className="stack">
        ...
        <section className="card">
          ...
          <div className="stack" style={{ marginTop: 12, gap: 12, fontSize: 13, color: "var(--muted)" }}>
            <p>
              <strong style={{ color: "var(--ink-2)" }}>Capture first, triage later.</strong> Use the Inbox to
              file quick notes and captures. Don&apos;t leave things in your head.
            </p>
            <p>
